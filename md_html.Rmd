...
#head(simpsons_sub)
#rmarkdown::paged_table(head(simpsons_sub))
```
...
rmarkdown::paged_table(head(arrange(simpsons_sub, desc(number_in_season))))
...
- Missing data points, originally missed because of type issue
  ...
  - Data is missing from Wikipedia
    - Interesting observation made -- Wikipedia articles report viewership in both (presumed) individual viewers and viewing households
      ...
      - Ratio comparing existing data of viewers to viewing household came to be about 1.7-8:1 (for case of season 8)
...
simpsons[simpsons$id == 680,]
(warrin_priests1 <- simpsons[680,])
